...
namespace Prodesp.Gsnet.Monitor.Domain.Implementacoes.Domain.Servicos
{
    public class JustificativaService : ServiceBase<Justificativa, IJustificativaRepository>, IJustificativaService
    {
        ...
        public void JustificarPorPrograma(int idPrograma, int idJustificador, MotivoAcao motivo, MotivoAcao acao,int? idGestor = null)
        {
            var itens = this._itemMonitoramentoRepository.BuscarPorPrograma(idPrograma,idGestor);
