...
namespace Prodesp.Gsnet.Monitor.CrossCutting.TO.Mapper.Profiles
{
    public class DomainToViewModelMappingProfile : Profile
    {
        public DomainToViewModelMappingProfile() : base()
        {
            ...
            CreateMap<ProgramaSaude, ProgramaSaudeViewModel>();
            ...
            CreateMap<HistoricoJustificativaDTO, ListHistoricoJustificativaViewModel>()
                ...
                .AfterMap((src, dest) => {
                    ...
                    decimal value = Convert.ToDecimal(src.ConsumoMedex.GetValueOrDefault()) / 20;
                    dest.ConsumoMedex = Math.Ceiling(value).ToString();
                    });
            ...
            CreateMap<Gestor, GestorViewModel>();
        }
    }
}