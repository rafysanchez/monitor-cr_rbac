...
export class ProdespMonitorModalNovaJustificativaComponent extends ModalComponent<IModalNovaJustificativa> implements OnInit, IModalNovaJustificativa {
  ...
  constructor(private motivoAcaoService: MotivoAcaoService, dialogService: DialogService, userService: UserService) {
    super(dialogService);
    this.usuarioCAF = userService.getUser().IdJustificador === 2;
  }
