...
var ProdespMonitorModalNovaJustificativaComponent = (function (_super) {
    ...
    function ProdespMonitorModalNovaJustificativaComponent(motivoAcaoService, dialogService, userService) {
        var _this = _super.call(this, dialogService) || this;
        _this.motivoAcaoService = motivoAcaoService;
        _this.acoes = [];
        _this.motivos = [];
        _this.ErrorCAF = null;
        _this.usuarioCAF = userService.getUser().IdJustificador === 2;
        return _this;
    }
    ...
    ProdespMonitorModalNovaJustificativaComponent.prototype.isValid = function () {
        if (!this.usuarioCAF) {
            return true;
        }
        else {
            return this.novaJustificativa.UsarJustificativaCAF || this.novaJustificativa.UsarJustificativaCAFPublica;
        }
    };
...
ProdespMonitorModalNovaJustificativaComponent = __decorate([
    ...
    __metadata("design:paramtypes", [motivoacao_service_1.MotivoAcaoService, ng2_bootstrap_modal_1.DialogService, user_service_1.UserService])
