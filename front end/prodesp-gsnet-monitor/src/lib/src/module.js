...
var crashreport_service_1 = require("./service/crashreport.service");
var prodesp_gsnet_monitor_component_1 = require("./components/prodesp-gsnet-monitor/prodesp-gsnet-monitor.component");
var menufilter_pipe_1 = require("./pipes/menufilter.pipe");
...
var prodesp_monitor_modal_deletar_component_1 = require("./components/prodesp-monitor-modal-deletar/prodesp-monitor-modal-deletar.component");
...
ProdespGsnetMonitorModule = ProdespGsnetMonitorModule_1 = __decorate([
    core_1.NgModule({
        ...
        declarations: [
            ...
            menufilter_pipe_1.MenuFilterPipe,
            prodesp_monitor_modal_deletar_component_1.ProdespMonitorModalAcaoBlocoComponent,
            prodesp_gsnet_monitor_component_1.ProdespGsnetMonitorComponent
        ],
        providers: [
            { provide: core_1.ErrorHandler, useClass: crashreport_service_1.ProdespErrorHandler },
            ng2_bootstrap_modal_1.DialogService,
            crashreport_service_1.CrashreportService,
            acao_service_1.AcaoService,
            motivo_service_1.MotivoService,
            indicadores_service_1.IndicadoresService,
            motivoacao_service_1.MotivoAcaoService,
            ...
            programasaude_service_1.ProgramaSaudeService,
